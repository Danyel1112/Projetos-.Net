...
//List<string> listaDasBandas = new List<string> { "U2", "The Beatles", "Calypso", "Pink Floyd"};
...
void MediaDasBandas()
{
    ...
    Console.Write("Digite o nome da banda que deseja ver a médias: "); 
    string nomeDaBanda = Console.ReadLine()!;
    ...
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
        ...
        if(notasDaBanda.Count > 0)
        {
            ...
            double media = somaDasNotas / notasDaBanda.Count;
